...
- [Morisawa BIZ UDGothic](https://github.com/googlefonts/morisawa-biz-ud-gothic)
  ...
  - [BIZ UDP Gothic (Google Fonts)](https://fonts.google.com/specimen/BIZ+UDPGothic?subset=japanese&noto.script=Jpan)
- [M + fonts](https://mplus-fonts.osdn.jp/about2.html)
  - [M PLUS Rounded 1c (Google Fonts)](https://fonts.google.com/specimen/M+PLUS+Rounded+1c?subset=japanese&noto.script=Jpan)
  - [M PLUS 1 (Google Fonts)](https://fonts.google.com/specimen/M+PLUS+1?subset=japanese&noto.script=Jpan)
...
- [さわらびゴシック](https://sawarabi-fonts.osdn.jp)
  - [Sawarabi Gothic (Google Fonts)](https://fonts.google.com/specimen/Sawarabi+Gothic?subset=japanese&noto.script=Jpan)
- [Murecho](https://github.com/positype/Murecho-Project)
  - [Morecho (Google Fonts)](https://fonts.google.com/specimen/Murecho?subset=japanese&noto.script=Jpan)
- [Zen Kaku Gothic new (Google Fonts)](https://fonts.google.com/specimen/Zen+Kaku+Gothic+New?subset=japanese)
- [Mochiy Pop One](https://fonts.google.com/specimen/Mochiy+Pop+One?subset=japanese)
- [Kaisei](https://github.com/FontKai-Kaisei/Kaisei)
  - [Kaisei Opti (Google Fonts)](https://fonts.google.com/specimen/Kaisei+Opti?subset=japanese&noto.script=Jpan&query=Font-Kai)
  - [Kaisei Decol (Google Fonts)](https://fonts.google.com/specimen/Kaisei+Decol?subset=japanese&noto.script=Jpan&query=Font-Kai)
...
- [Morisawa BIZ UDGothic](https://github.com/googlefonts/morisawa-biz-ud-gothic)
  - [BIZ UD Mincho (Google Fonts)](https://fonts.google.com/specimen/BIZ+UDMincho?subset=japanese&noto.script=Jpan)
